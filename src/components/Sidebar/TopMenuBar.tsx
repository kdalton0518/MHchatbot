...
export function TopMenuBar() {
  ...
  return (
    <header className='bg-gradient-to-br from-emerald-100 to-emerald-100 dark:from-black dark:to-black sticky top-0 z-40 w-full border-b shadow-sm dark:border-gray-800'>
