...
export function ThemeToggle() {
  ...
  return (
    <Button
      variant='ghost'
      size='sm'
      className='bg-gradient-to-br from-emerald-100 to-emerald-100 dark:from-black dark:to-black hover:bg-gradient-to-br hover:from-green-50 hover:to-green-50 dark:hover:from-black dark:hover:to-black'
